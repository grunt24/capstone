...
function StudentSubject() {
    ...
    const filteredStudents = students
        ...
        .sort((a, b) => {
            ...
            return sortAsc ? nameA.localeCompare(nameB) : nameB.localeCompare(a);
        });
                                ...
                                {expandedUserId === student.id && subjectsMap[student.id] && (
                                    <tr>
                                        <td colSpan="4" className="bg-light">
                                            <h5 className="mb-3">Grades for {student.fullname}</h5>
                                                        ...
                                                        {subject.scores.length > 0 ? (
                                                            <>
                                                                ...
                                                                <div className="d-flex justify-content-end align-items-center mt-2">
                                                                    <strong className="me-3">Calculated Grade: {subject.calculatedGrade ? `${subject.calculatedGrade}%` : '-'}</strong>
                                                                    <strong>Main Grade: {subject.mainGrade || '-'}</strong>
                                                                </div>
                                                            </>
                                                        ) : (
