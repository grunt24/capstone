    ...
    <div className="container" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
      <div className="form-container">
        ...
        <Form className="form" onFinish={handleSubmit}>
          ...
          <p className="page-link">{/* <span className="page-link-label">Forgot Password?</span> */}</p>
          <Button htmlType="submit" className="form-btn" block disabled={loading}>
            {loading ? <Spin size="small" /> : "Login"}
          </Button>
        </Form>
        <p className="sign-up-label">{/* Don't have an account? <span className="sign-up-link">Sign up</span> */}</p>
      </div>
    </div>
  );
};
